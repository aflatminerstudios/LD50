...
instance_create_depth(400, 300, depth , objGameSelectBG);

carts[0] = instance_create_layer(217, 225, "Instances", objGameCart);
carts[0].cartNum = 0;
...
carts[1] = instance_create_layer(431, 225, "Instances", objGameCart);
carts[1].cartNum = 1;
...
carts[2] = instance_create_layer(655, 225, "Instances", objGameCart);
carts[2].cartNum = 2;
...
carts[3] = instance_create_layer(217, 444, "Instances", objGameCart);
carts[3].cartNum = 3;
...
carts[4] = instance_create_layer(431, 444, "Instances", objGameCart);
carts[4].cartNum = 4;
...
carts[5] = instance_create_layer(655, 444, "Instances", objGameCart);
carts[5].cartNum = 4;
